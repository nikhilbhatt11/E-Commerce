    ...
    <div className="flex items-center justify-center px-4">
      ...
      >
        <div className="flex flex-col items-center md:flex-row">
          ...
          <p className="text-sm lg:text-base dark:text-gray-600 text-gray-600 lg:pt-1 xl:pt-0 sm:mb-0 mb-2 text-center sm:text-left">
            {message}
          </p>
        </div>
        <div className="flex xl:items-center lg:items-center sm:justify-end justify-center pr-4">
          <button
            className="focus:outline-none focus:text-indigo-400 hover:text-indigo-400 text-sm mr-4 font-bold cursor-pointer text-indigo-700 dark:text-indigo-600"
            onClick={removeAlert}
          >
            Dismiss
          </button>
